...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "Browser", "Terminal", "Random", "Telegram", "Code", "6", "7" }, s, awful.layout.layouts[1])
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "top", screen = s ,fg = beautiful.fg_normal, height = 26})
